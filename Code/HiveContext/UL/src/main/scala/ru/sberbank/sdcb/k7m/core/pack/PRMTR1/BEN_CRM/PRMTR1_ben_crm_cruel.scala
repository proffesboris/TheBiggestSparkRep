...
class PRMTR1_ben_crm_cruel(config: Config) extends Table(config: Config){

	val dashboardName: String = genDashBoardName(PRMTR1_ben_crm_cruel_ShortName)
	val dashboardPath: String = genDashBoardPath(PRMTR1_ben_crm_cruel_ShortName)
